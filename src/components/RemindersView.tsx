...
export function RemindersView() {
  ...
  return <div className="reminders-view">
    ...
    {tab === "countdown" ? <>
      ...
      <TimerList title="我的倒计时" timers={countdowns} empty="还没有倒计时。选择一个时长，输入名称后即可开始。" onStart={startTimer} onPause={pauseTimer} onReset={resetTimer} onExtend={(id) => extendTimer(id, 300)} onRemove={removeTimer} completionLabel="完成" />
    </> : <>
